...
def generate():
    ...
    pdf.cell(200, 10, txt = '*RMSE: 0.63, **Accuracy: 98.74%', ln = 2, align = 'L')
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L') 
    ...
    pdf.cell(200, 10, txt = '*RMSE: 0.72, **Accuracy: 98.60%', ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L')
    ...
    pdf.cell(200, 10, txt = '*RMSE: 0.84 ', ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L') 
