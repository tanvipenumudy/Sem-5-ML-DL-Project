...
def generate():
    ...
    pdf.add_page() 
    pdf.set_font("Arial") 
    pdf.cell(200, 20, txt = "Informal Educational Assessment Report",  ln = 1, align = 'C') 
    ...
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = "Test Performance:", ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = "", ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = "1. Schonell's Spelling Test -", ln = 2, align = 'L') 
    ...
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = "2. Burt's Reading Test -", ln = 2, align = 'L')  
    ...
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L')
    pdf.cell(200, 10, txt = "3. Auditory Sequential Memory Test (Digit Span) -", ln = 2, align = 'L') 
    ...
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = "4. Wepman's Auditory Discrimination Test -", ln = 2, align = 'L')   
    ...
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = "5. Grade-Level Comprehensive Understanding Test -", ln = 2, align = 'L') 
    ...
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L')  
    pdf.cell(200, 10, txt = 'Performance - ', ln = 2, align = 'L')  
    pdf.cell(200, 10, txt = '1. Severe: Needs Remediation', ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = '2. Mild: Observation Required, Needs to Review after 1 Year ', ln = 2, align = 'L')  
    pdf.cell(200, 10, txt = '3. Average: Performing on an Average Level', ln = 2, align = 'L')  
    pdf.cell(200, 10, txt = '4. Good: Performing Above Average', ln = 2, align = 'L')
    pdf.cell(200, 10, txt = '5. Well: Performing Really Well', ln = 2, align = 'L')
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L')  
