...
def generate():
    ...
    pdf.cell(200, 10, txt = "Date of Assessment: "+d1.replace('/','-'), ln = 2, align = 'L')
    ...
    pdf.cell(200, 10, txt = '*RMSE - Train: 0.63, Test: 0.82 **Accuracy - Train: 98.74%, Test: 95.77%', ln = 2, align = 'L')
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L') 
    ...
    pdf.cell(200, 10, txt = '*RMSE - Train: 0.72, Test: 1.24 **Accuracy - Train: 98.60%, Test: 96.67%', ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L')
    ...
    pdf.cell(200, 10, txt = '*RMSE - Train: 0.84, Test: 1.87 **Accuracy - Train: 100%, Test: 96.90%', ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L') 
    ...
    pdf.cell(200, 10, txt = '*Accuracy - Train: 100%, Test: 97.60%', ln = 2, align = 'L')  
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L') 
    ...
    pdf.cell(200, 10, txt = '*Accuracy - Train: 100%, Test: 99.67%', ln = 2, align = 'L')  
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L')  
    ...
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L')  
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = 'Report Generated on '+dt.replace('/','-'), ln = 2, align = 'C') 
