...
def score():
    from app import current_user
    user = User.query.get_or_404(current_user.id)
    return render_template('score.html', schonell=user.schonell, wepman=user.wepman, burt=user.burt)
...
def generate():
    ...
    pdf.cell(200, 10, txt = "", ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = "Schonell's Test Score: " +str(user.schonell), ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = "Spelling Age*: "+str((user.sch1)//12)+' years'+' '+str((user.sch1)%12)+' months', ln = 2, align = 'L')  
    pdf.cell(200, 10, txt = "Schonell's Test (Performance)*: "+user.sch, ln = 2, align = 'L')  
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L')  
    pdf.cell(200, 10, txt = "Burt's Test Score: " +str(user.burt), ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = "Reading Age*: "+str((user.bur1)//12)+' years'+' '+str((user.bur1)%12)+' months', ln = 2, align = 'L')  
    pdf.cell(200, 10, txt = "Burt's Test (Performance)*: "+user.bur, ln = 2, align = 'L')  
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L')  
    ...
    pdf.cell(200, 10, txt = '', ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = "Wepman's Test Score: " +str(user.wepman), ln = 2, align = 'L') 
    pdf.cell(200, 10, txt = "Auditory Disability: "+user.wep, ln = 2, align = 'L')  
